...
def search(maze, start, end, heuristic_method="euclidean"):
    print("searching ....")
    ...
    start_node.g = 0
    start_node.h = heuristic(start, end, method=heuristic_method)
    ...
    while len(yet_to_visit_dict) > 0:
        ...
        for child in children:
            ...
            child.h = heuristic(child.position, end, method=heuristic_method)
